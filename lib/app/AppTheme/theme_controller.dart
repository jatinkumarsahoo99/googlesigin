...
import 'package:google_login/app/AppTheme/themes.dart';

import '../provider/enum.dart';
...
class ThemeController extends GetxController {
  ...
  static Future<ThemeController> init() async {
    await SharedPreferencesKeys().setColorType(ColorType.malibu);
    await SharedPreferencesKeys().setFontType(FontFamilyType.montserrat);
